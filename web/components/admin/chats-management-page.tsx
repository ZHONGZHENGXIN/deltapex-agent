          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-red-200/60 bg-gradient-to-r from-red-500/10 via-red-500/5 to-transparent backdrop-blur-sm dark:border-red-900/40">
                <TableHead className="min-w-[80px] font-semibold text-red-700 dark:text-red-300">{t('table.chatId')}</TableHead>
                <TableHead className="min-w-[80px] font-semibold text-red-700 dark:text-red-300">{t('table.userId')}</TableHead>
                <TableHead className="min-w-[180px] font-semibold text-red-700 dark:text-red-300">{t('table.userEmail')}</TableHead>
                <TableHead className="min-w-[120px] font-semibold text-red-700 dark:text-red-300">{t('table.username')}</TableHead>
                <TableHead className="min-w-[200px] font-semibold text-red-700 dark:text-red-300">{t('ui.title')}</TableHead>
                <TableHead className="min-w-[100px] font-semibold text-red-700 dark:text-red-300">{t('table.messageCount')}</TableHead>
                <TableHead className="min-w-[140px] font-semibold text-red-700 dark:text-red-300">{t('table.createdTime')}</TableHead>
                <TableHead className="min-w-[140px] font-semibold text-red-700 dark:text-red-300">{t('table.lastUpdate')}</TableHead>
